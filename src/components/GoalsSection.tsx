    ...
    <section className="px-6 py-[60px]">
      <div className="max-w-[1080px] mx-auto bg-[radial-gradient(ellipse_55%_50%_at_90%_10%,rgba(149,140,232,.12)_0%,transparent_50%),radial-gradient(ellipse_45%_45%_at_5%_90%,rgba(172,209,253,.1)_0%,transparent_50%),#fff] rounded-[28px] px-[32px] md:px-[64px] py-[48px] md:py-[72px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-[18px] mb-[28px]">
          <ScrollReveal delay={100} className="border border-border rounded-[18px] px-[26px] pb-[30px] pt-[16px] flex flex-col items-center text-center gap-[14px] bg-white transition-all duration-200 hover:border-purple hover:-translate-y-[3px]">
            <div className="w-[180px] shrink-0 flex justify-center">
              <Image src="/lose-weight.png" alt="Lose weight" width={180} height={220} className="w-full h-auto object-contain" />
            </div>
            ...
            <div className="flex w-full justify-center items-center gap-[6px] text-[12px] font-[800] text-purple pt-[12px] border-t border-border mt-auto">
              <span>→</span> Fitakka tracks your deficit every day
            </div>
          </ScrollReveal>

          <ScrollReveal delay={200} className="border border-border rounded-[18px] px-[26px] pb-[30px] pt-[16px] flex flex-col items-center text-center gap-[14px] bg-white transition-all duration-200 hover:border-purple hover:-translate-y-[3px]">
            <div className="w-[180px] shrink-0 flex justify-center">
              <Image src="/gain-muscle.png" alt="Gain muscle" width={180} height={220} className="w-full h-auto object-contain" />
            </div>
          ...
          <ScrollReveal delay={300} className="border border-border rounded-[18px] px-[26px] pb-[30px] pt-[16px] flex flex-col items-center text-center gap-[14px] bg-white transition-all duration-200 hover:border-purple hover:-translate-y-[3px]">
            <div className="w-[180px] shrink-0 flex justify-center">
              <Image src="/body-transformation.png" alt="Body transformation" width={180} height={220} className="w-full h-auto object-contain" />
            </div>
