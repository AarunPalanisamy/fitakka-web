        ...
        <ScrollReveal>
          <div className="grid grid-cols-1 lg:grid-cols-3 border border-border rounded-[20px] overflow-hidden">
            ...
            <div className="p-10 lg:p-11 border-b lg:border-b-0 lg:border-r border-border flex flex-col transition-colors hover:bg-[#FAFAFE]">
              ...
              <div className="text-[20px] font-[900] text-ink leading-[1.2] tracking-[-0.4px] mb-3">Most fitness apps are a <em className="italic text-purple">second job.</em></div>
              ...
              <div className="mt-auto flex flex-col">
                ...
                <div className="flex flex-col items-center justify-center text-center pt-6 border-t border-border lg:min-h-[200px]">
            ...
            <div className="p-10 lg:p-11 border-b lg:border-b-0 lg:border-r border-border flex flex-col transition-colors hover:bg-[#FAFAFE]">
              ...
              <div className="text-[20px] font-[900] text-ink leading-[1.2] tracking-[-0.4px] mb-3">A dashboard shows you the past. <em className="italic text-purple">Fitakka changes today.</em></div>
            ...
            <div className="p-10 lg:p-11 flex flex-col transition-colors hover:bg-[#FAFAFE]">
              ...
              <div className="text-[20px] font-[900] text-ink leading-[1.2] tracking-[-0.4px] mb-3">Information doesn&apos;t change behaviour. <em className="italic text-purple">Habits do.</em></div>
